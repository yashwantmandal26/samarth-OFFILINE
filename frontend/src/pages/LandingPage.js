          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  to="/finder"
                  className="w-full sm:w-auto px-10 py-5 bg-slate-900 text-white rounded-[1.5rem] font-bold text-lg hover:bg-slate-800 transition-all shadow-2xl shadow-slate-200 flex items-center justify-center gap-3 group active:scale-95"
                >
                  Find My Schemes <Search size={20} className="group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link
                  to="/chat"
                  className="w-full sm:w-auto px-10 py-5 bg-white text-slate-700 border border-slate-200 rounded-[1.5rem] font-bold text-lg hover:border-primary-200 hover:text-primary-600 transition-all flex items-center justify-center gap-3 active:scale-95 shadow-sm"
                >
      ...
      <section className="py-32 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <Link
              to="/finder"
              className="px-12 py-6 bg-primary-500 text-white rounded-[2rem] font-black uppercase tracking-widest text-sm hover:bg-primary-400 transition-all shadow-2xl shadow-primary-900/50 active:scale-95 flex items-center gap-3"
            >
